...
*/
package jp.co.akiguchilab.healthcaremanagement.calendar.view.dialog;
...
import jp.co.akiguchilab.healthcaremanagement.calendar.view.dialog.TimePickerEx.OnTimeChangedListener;
...
public class TimePickerDialogEx extends AlertDialog implements OnClickListener, OnTimeChangedListener {
    ...
    /* (non-Javadoc)
     * @see jp.co.akiguchilab.healthcaremanagement.calendar.view.dialog.TimePickerEx.OnTimeChangedListener#onTimeChanged(jp.co.akiguchilab.healthcaremanagement.calendar.view.dialog.TimePickerEx, int, int)
     */
    @Override
