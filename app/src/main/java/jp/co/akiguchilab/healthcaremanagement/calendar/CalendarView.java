...
public class CalendarView extends LinearLayout {
     ...
     * @param context context
     */
    private void createTitleView(Context context, AttributeSet attrs) {
        float scaleDensity = context.getResources().getDisplayMetrics().density;

        LinearLayout navBar = new LinearLayout(context);
        navBar.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        {
            Button btnBack = new Button(context, attrs);
            btnBack.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, 5));
            btnBack.setBackgroundColor(TODAY_BACKGROUND_COLOR);
            btnBack.setText("<<");
            ...
            btnBack.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    set(calendar.get(Calendar.YEAR), --PRESERVE_MONTH);
                }
            });
            ...
            btnFwd.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, 5));
            btnFwd.setBackgroundColor(TODAY_BACKGROUND_COLOR);
            btnFwd.setGravity(Gravity.CENTER);
            btnFwd.setText(">>");
